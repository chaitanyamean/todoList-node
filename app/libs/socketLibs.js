...
let setServer = (server) => {
    ...
    io.on('connection',(socket) => {
       ...
       // socket.emit("verifyUser", {status: 200, message: 'Verified Successfully'});
        ...
        // socket.on('send-friendship', (data) => {
        ...
        // socket.on('accept-friendship', (data) => {
        //     console.log('friendship inside', data);
        //    setTimeout(() => {
        //        eventEmitter.emit('friendship', data);
        //    }, 2000);
        //   io.emit(data.requestedToId, data)
        //    io.emit(data.requestedById, data)
        // }) // end of edit-meeting
